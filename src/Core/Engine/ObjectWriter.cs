...
namespace NDatabase.Core.Engine
{
    ...
    internal sealed class ObjectWriter : IObjectWriter
    {
                                              ...
                                              bool addDependentClasses)
        {
            ...
            Log4NetHelper.Instance.LogDebugMessage("ObjectWriter: class " + newClassInfo.FullClassName + " has " + numberOfAttributesAsString + " attributes");
            ...
            if (metaModel.GetNumberOfClasses() > 0 && lastClassInfoIndex != -2)
            {
                ...
                Log4NetHelper.Instance.LogDebugMessage("ObjectWriter: changing next class oid. of class info " + lastClassinfo.FullClassName + "@ " +
        ...
        private void WriteClassInfoHeader(ClassInfo classInfo, long position, bool writeInTransaction)
        {
            ...
            Log4NetHelper.Instance.LogDebugMessage("ObjectWriter: Writing new Class info header at " + positionAsString + " : " + classInfo);
        ...
        public OID Delete(ObjectInfoHeader header)
        {
            ...
            Log4NetHelper.Instance.LogDebugMessage("ObjectWriter: Deleting object with id " + header.GetOid() + " - In connected zone =" +
                          isInConnectedZone + " -  with index =" + hasIndex);

            var positionAsString = objectPosition.ToString();
            Log4NetHelper.Instance.LogDebugMessage("ObjectWriter: position =  " + positionAsString + " | prev oid = " + previousObjectOID + " | next oid = " +
                          nextObjectOID);
        ...
        {
            var positionAsString = position.ToString();
            Log4NetHelper.Instance.LogDebugMessage("ObjectWriter: Writing new Class info body at " + positionAsString + " : " + classInfo);
            // updates class info
        ...
        {
            var positionAsString = position.ToString();
            Log4NetHelper.Instance.LogDebugMessage(string.Concat("ObjectWriter: Writing native object at", positionAsString,
        ...
        {
            Log4NetHelper.Instance.LogDebugMessage(string.Concat("ObjectWriter: Storing free space at position ", currentPosition.ToString(),
